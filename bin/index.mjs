...
/*global module*/
var Buffer = (__nccwpck_require__(1867).Buffer);
var DataStream = __nccwpck_require__(2394);
...
const flatted = __nccwpck_require__(8048);
...
const debug = __nccwpck_require__(8237)('log4js:categoryFilter');
...
const streams = __nccwpck_require__(5735);
const os = __nccwpck_require__(2037);
...
const debug = __nccwpck_require__(8237)('log4js:file');
const path = __nccwpck_require__(1017);
const streams = __nccwpck_require__(5735);
const os = __nccwpck_require__(2037);
...
const debug = __nccwpck_require__(8237)('log4js:fileSync');
const path = __nccwpck_require__(1017);
const fs = __nccwpck_require__(7147);
const os = __nccwpck_require__(2037);
...
const path = __nccwpck_require__(1017);
const debug = __nccwpck_require__(8237)('log4js:appenders');
const configuration = __nccwpck_require__(5813);
const clustering = __nccwpck_require__(2560);
const levels = __nccwpck_require__(7117);
const layouts = __nccwpck_require__(2680);
const adapters = __nccwpck_require__(3915);

// pre-load the core appenders so that webpack can find them
const coreAppenders = new Map();
coreAppenders.set('console', __nccwpck_require__(4813));
coreAppenders.set('stdout', __nccwpck_require__(9601));
coreAppenders.set('stderr', __nccwpck_require__(6451));
coreAppenders.set('logLevelFilter', __nccwpck_require__(790));
coreAppenders.set('categoryFilter', __nccwpck_require__(8712));
...
const debug = __nccwpck_require__(8237)('log4js:categories');
const configuration = __nccwpck_require__(5813);
const levels = __nccwpck_require__(7117);
...
const dateFormat = __nccwpck_require__(2087);
const os = __nccwpck_require__(2037);
const util = __nccwpck_require__(3837);
const path = __nccwpck_require__(1017);
...
const levels = __nccwpck_require__(7117);
const appenders = __nccwpck_require__(5709);
const categories = __nccwpck_require__(5798);
const Logger = __nccwpck_require__(7619);
const clustering = __nccwpck_require__(2560);
...
const debug = __nccwpck_require__(8237)("streamroller:RollingFileWriteStream");
const fs = __nccwpck_require__(5630);
const path = __nccwpck_require__(1017);
const os = __nccwpck_require__(2037);
const newNow = __nccwpck_require__(9652);
const format = __nccwpck_require__(2087);
...
module.exports = {
  ...
  RollingFileStream: __nccwpck_require__(5476),
  DateRollingFileStream: __nccwpck_require__(3917)
};
...
const debug = __nccwpck_require__(8237)('streamroller:moveAndMaybeCompressFile');
const fs = __nccwpck_require__(5630);
...
module.exports = __WEBPACK_EXTERNAL_createRequire(import.meta.url)("cluster");
...
;// CONCATENATED MODULE: ./node_modules/appstore-connect-jwt-generator-core/esm/index.mjs
...
function tokenSync(privateKey, issuerId, privateKeyId, duration = 500) {
    return jsonwebtoken.sign({}, privateKey, signOption(issuerId, privateKeyId, duration));
}
async function token(privateKey, issuerId, privateKeyId, duration = 500) {
    return Promise.resolve(jsonwebtoken.sign({}, privateKey, signOption(issuerId, privateKeyId, duration)));
}
jwtGenCore.tokenSync = tokenSync;
jwtGenCore.token = token;
/* harmony default export */ const esm = (jwtGenCore);
...
var arg = __nccwpck_require__(9482);
...
// EXTERNAL MODULE: ./node_modules/log4js/lib/log4js.js
var log4js = __nccwpck_require__(3048);
...
log4js.configure(JSON.parse('{"appenders":{"out":{"layout":{"pattern":"%m%n","type":"pattern"},"type":"stdout"}},"categories":{"default":{"appenders":["out"],"level":"info"}}}'));
let p = log4js.getLogger(), a = {
    '--help': {
        type: Boolean,
        alias: '-h'
    },
...
try {
    let d = arg(c), f = JSON.parse(Buffer.from(external_fs_.readFileSync(__nccwpck_require__.ab + "package.json", JSON.parse('{"flag":"r"}'))).toString()), u = chalkTemplate`
  {bold USAGE}
...
`;
    ...
    let m = d['--cert'], y = external_fs_.readFileSync(m, JSON.parse('{"flag":"r"}')), g = esm.tokenSync(y, d['--issuerId'], d['--keyId'], void 0);
    p.info(chalkTemplate`
{bold token}
${g}
`);
} catch (I) {
...
;// CONCATENATED MODULE: ./bin/cli.mjs
